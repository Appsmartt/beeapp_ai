...
export default function CalendarModule() {
  ...
  return (
    <div className="bg-white min-h-full flex flex-col lg:flex-row pb-24 lg:pb-0">
      ...
      {/* LEFT COLUMN: Calendar Strip & Events */}
      ...
      <div className="p-4 border-b border-neutral-100 space-y-3 sticky top-0 bg-white z-10">
        ...
        <div className="flex items-center justify-between gap-1 pt-1">
          <button className="p-1 text-neutral-400 hover:text-neutral-800">
      ...
      {/* RIGHT COLUMN: Calendar Event Detail */}
      <div className={`flex-1 flex-col ${selectedEvent ? 'flex' : 'hidden lg:flex'}`}>
        {selectedEvent ? (
          <CalendarEventDetail
            event={selectedEvent}
          ...
          <div className="hidden lg:flex flex-1 items-center justify-center p-12 text-center text-neutral-400 bg-neutral-50/50">
            <div className="space-y-3 max-w-xs">
              ...
              <p className="text-xs text-neutral-500 font-normal">
                Selecciona un compromiso de la lista de la izquierda para ver su horario y enlace de videollamada.
              </p>
            </div>
          </div>
        )}
