...
import { X, ImagePlus, Plus, Trash2, Tag, FileText, DollarSign, Monitor } from 'lucide-react-native';
import { BusinessService, ServiceMode, ProductCharacteristic } from '../../mocks/myServices';
...
export default function CreateServiceModal({
  ...
  const [mode, setMode] = useState<ServiceMode>(allowedServiceModes[0] || 'virtual');
  ...
  useEffect(() => {
    if (visible) {
      ...
      setMode(initialData?.mode ?? allowedServiceModes[0] ?? 'virtual');
      setSubmitted(false);
    }
  }, [visible, initialData, allowedServiceModes]);
      ...
      <View style={styles.container}>
        ...
        >
          ...
          <TextInput
            ...
            placeholder="Ej. Asesoría Financiera"
          ...
          <TextInput
            ...
            placeholder="Especificaciones o descripción del servicio..."
            placeholderTextColor={colors.neutral.gray400}
            value={description}
          ...
          <TextInput
            style={styles.input}
            placeholder="Dejar vacío para 'Cotización'"
            placeholderTextColor={colors.neutral.gray400}
          ...
          {/* Images */}
          <Text style={styles.sectionTitle}>Imágenes del servicio ({images.length}/5)</Text>
          ...
          <View style={[styles.labelRow, { marginTop: 14 }]}>
            <Monitor size={15} color={colors.neutral.gray500} />
            <Text style={styles.label}>Modalidad *</Text>
          </View>
          <View style={styles.chipsWrap}>
            {allowedServiceModes.map((m) => {
          ...
          {characteristics.map((char, index) => (
            <View key={index} style={styles.charRow}>
              <TextInput
                ...
                placeholder="Propiedad (ej. Duración)"
                placeholderTextColor={colors.neutral.gray400}
                value={char.name}
