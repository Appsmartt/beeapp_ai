...
MAIL_SYNC_RUN_COLUMNS = (
    "id,user_id,mail_integration_id,trigger,status,"
    "is_full_sync,started_at,completed_at,"
    "messages_fetched_count,messages_created_count,"
    "messages_updated_count,messages_deleted_count,"
    "messages_skipped_count,cursor_before,cursor_after,"
