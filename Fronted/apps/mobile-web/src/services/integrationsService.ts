...
export const PROVIDER_OPTIONS: ProviderOption[] = [
    {
        ...
        name: 'Google',
        description: (
        'Conecta Gmail, Calendar, Contactos y Drive '
        + 'con una única autorización.'
        ),
        iconLetter: 'G',
        iconColor: '#4285F4',
        availability: 'available',
        capabilitiesLabel: 'Gmail, Calendar, Contactos y Drive',
    },
    {
        provider: 'microsoft',
        name: 'Microsoft',
        description: (
        'Conecta Outlook, Calendar y servicios de '
        + 'Microsoft 365.'
        ),
        iconLetter: 'M',
        iconColor: '#0078D4',
...
export function getConnectionStatusPresentation(
    ...
    switch (status) {
        ...
        return {
            ...
            color: '#DC2626',
            helperText: 'No fue posible usar esta autorización.',
        };
