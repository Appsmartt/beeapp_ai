...
selectedRequestModality: CommercialModality | null;
onRemove: () => void;
}) {
const isBookingLine = (
...
Modalidad seleccionada: {modalityLabel(selectedRequestModality)}
</Text>
) : null}
...
const bookingLine = cart?.lines.find((line) => (
line.offerKind === 'service' && line.requiresBooking
));

if (bookingLine) {
updateBusinessCartBookingDetails(bookingLine.id, {
...
selectedRequestModality={cart.requestedModality}
onRemove={() => {
Alert.alert(
